...
CREATE SCHEMA IF NOT EXISTS TEST.TELCO;
USE SCHEMA TEST.TELCO;
...
PUT file:///Users/pjain/work/telco/data/telco_data.csv @data_upload overwrite=true;
PUT file:///Users/pjain/work/telco/data/schema_detection.parquet @data_upload overwrite=true;
PUT file:///Users/pjain/work/telco/data/001_email.eml @unstructured_customer_data auto_compress = false overwrite=true;
PUT file:///Users/pjain/work/telco/data/002_email.eml @unstructured_customer_data auto_compress = false overwrite=true;
PUT file:///Users/pjain/work/telco/data/LogEmailResponse.jar @unstructured_dependency_jars auto_compress = false overwrite=true;
PUT file:///Users/pjain/work/telco/data/tika-app-2.0.0.jar @unstructured_dependency_jars auto_compress = false overwrite=true;
